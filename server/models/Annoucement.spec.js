...
describe('Annoucement', () => {
    ...
    it('border and background color, message and date', async () => {
        ...
        expect(testAnnoucement.message).to.equal('asdf asdf asdf asdf asdf asdf asdf asdf')
    ...
    describe('borderColor', () => {
        ...
        xit('cannot be an empty string', async () => {
            ...
            try {
                ...
                expect(err.message).to.contain('Validation notEmpty on borderColor failed');
            }
        })
    })
    describe('backgroundColor', () => {
        ...
        xit('cannot be an empty string', async () => {
            ...
            try {
                ...
                expect(err.message).to.contain('Validation notEmpty on backgroundColor failed');
            }
        })
    })
    describe('message', () => {
