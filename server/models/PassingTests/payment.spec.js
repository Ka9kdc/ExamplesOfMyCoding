         ...
         it('cannot be negetive', async () => {
          ...
          it('cannot have decimal places', async () => {
            ...
            try {
              ...
              throw Error('validation should have failed with to many decimals amount');
            } catch (err) {
...
describe('Payment Date', () => {
    ...
    it('cannot be empty', async () => {
      ...
      try {
        ...
        expect(err.message).to.contain('Validation notEmpty on PaymentDate failed');
      }
    });
    it('must be a date', async () => {
      ...
      try {
        ...
        expect(err.message).to.contain('Validation isDate on PaymentDate failed');
      }
    });
  })
})