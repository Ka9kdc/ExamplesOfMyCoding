...
const clubEvents = [
    ...
    {Name: 'Hamfest', Start: new Date(2021, 0, 17, 8), End: new Date(2021, 0, 17, 16), Location: 'Zoom', Type: 'Special Event'},
    ...
    {Name: 'Weekly Club Net', Start: new Date(2021, 0, 31, 20), End: new Date(2021, 0, 31, 20,30), Location: '444.475', Type: 'Net'},
    {Name: 'Weather Net', Start: new Date(2021, 1, 14, 19), End: new Date(2021, 1, 14, 19, 15), Location: '444.475', Type: 'Net'},
