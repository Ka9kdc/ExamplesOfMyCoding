...
const newProducts = [
  {
    ...
    onSale: true,
    description:
      'Entree Ticket with 4 raffle studs. Day off tickets come with only 1 stud and will be $10.',
    photo: '/Images/f89b7cbe4e61a04129304e6ce498afb2.png',
  },
  {
    name: 'Table',
    dataName: 'Tables',
    description: 'An 8 foot by 4 foot folding table.',
    price: 25,
    onSale: true,
  ...
  },
  {
    ...
    dataName: 'Chairs',
    description:
      'A metal folding chair. One chair is provided with each Vendor request.',
    price: 2,
    onSale: false,
