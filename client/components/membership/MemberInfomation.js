...
const MemberInformation = (props) =>{
    return (
        <div className='form'>
            ...
            <div><label htmlFor="City">City:  </label><input name="City" placeholder="City" value={props.member.City} type="text" required  onChange={() => props.handleChange(event)} /></div>
            <div><label htmlFor="State">State:  </label><States state={props.member.State}  handleChange={props.handleChange} /></div>
            <div><label htmlFor="Zip">Zip Code:  </label> <input name="Zip" value={props.member.Zip} type="text" required onChange={() => props.handleChange(event)} /></div>
     </div>
    )
}
