...
describe('FoxHunting Component', () => {
  ...
  describe('schedule table', () => {
    ...
    describe('1st weekend', () => {
        ...
        it('Start Location = Kmart in elmhurst', () => {
          expect(weekend[1]).to.be.equal('KMart Parking lot, Elmhurst, Rt 83 north of St Charles Rd');
        });
      ...
      describe('2nd weekend', () => {
        ...
        it('Start Location = Downers Grove Golf Club', () => {
          expect(weekend[1]).to.be.equal('Downers Grove Golf Club parking lot, Belmont Rd south of Odgen Ave');
        });
      ...
      describe('3rd weekend', () => {
        ...
        it('Start Location = Centennial park', () => {
          expect(weekend[1]).to.be.equal('Centennial Park, Addison, Rohlwing Rd, 0.4 miles south of Lake St');
        });
      ...
      describe('4th weekend', () => {
        ...
        it('Start Location = Wooddale', () => {
          expect(weekend[1]).to.be.equal('WoodDale Rd between Thorndale and Irving Pk Rd');
        });
  ...
  describe('Header', () => {
      let header;
      before(() => {
          header = foxhuntingPage.find('div').map(node => node.get(0).props).filter(div => div.className === 'Announcement')
        })
