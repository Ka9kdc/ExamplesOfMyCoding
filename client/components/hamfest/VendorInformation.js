        ...
        return (
            <div>
                ...
                <div>
                    ...
                    <div>
                        <label>Email:  </label><input name="Email" placeholder="Your email here (required)" required="" size="50" type="email" value={this.props.customerInfo.Email} onChange={() => this.handleChange(event)}/>
                        <label>   Phone Number: </label> <input name="Phone" placeholder="000-000-0000" type="tel" required size="15" value={this.props.customerInfo.Phone} onChange={() => this.handleChange(event)}/>
                    </div>
