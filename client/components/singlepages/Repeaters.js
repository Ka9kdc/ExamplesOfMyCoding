  ...
  return (
    <div >
      ...
      <div className="Content">
        <p>
          Wheaton Community Radio Amateurs, with coordination approval from the
          Illinois Repeater Association and adjacent state coordination,
        ...
        <table>
          <tbody>
            ...
            <tr>
              ...
              <td>107.2 (1B) PL Encode/Decode</td>
              <td>Auto In/Auto Out </td><td>*OFF THE AIR INDEFINITELY*</td>
            </tr>
            <tr>
        ...
        <p>
          On those months that have a FIFTH Sunday, the WCRA VHF net will take
          place on the UHF repeater at 8pm.
        </p>

        <p>
          We are constantly looking for folks to volunteer their time and
          talents to be control operators for the nets. Feel free to volunteer
