...
const Hamfest = (props) => {
  return (
    <div>
      <div className="Title">
        WCRA 2021 Mid-Winter Hamfest - WILL BE VIRTUAL
      </div>
      ...
      <div className="Content">
        ...
        <h3>
          As many have been wondering, we will be cancelling the hamfest as an
          in-person activity. The Hamfest committee has been working on putting
          on a Virtual Hamfest instead, more details to come.
        </h3>
        <div>
          <h2>Features</h2>
        ...
        <div>
          <h1>Vendor Info</h1>
          <p>
            <a href="Document/2021Hamfest-VendorNotification.pdf">
              Letter to vendors about our 2021 hamfest and how to participate
            </a>
            . If interested in participating, please contact the hamfest
            committee at{' '}
            <a href="mailto:hamfest@w9ccu.org">hamfest@w9ccu.org</a>.
          </p>
